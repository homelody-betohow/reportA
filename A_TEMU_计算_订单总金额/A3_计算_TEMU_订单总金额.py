...
no_temu_df = no_temu_df[
    ['平台', '店铺英文名', '站点', '订单类型', '参考号', '订单号', '平台sku', '仓库SKU', '仓库','仓库属性', '运输方式',
     '仓库SKU销量', '跟踪单号', '币种', '订单总金额', '平台运费', 'fba费用', '头程运费', '头程税费', '派送运费']
]
...
# 保留指定列  保证 拼接前  列名一致
temu_df = temu_df[
    ['平台', '店铺英文名', '站点', '订单类型', '参考号', '订单号', '平台sku', '仓库SKU', '仓库', '运输方式',
     '仓库SKU销量', '跟踪单号', '币种', '订单总金额', '平台运费', 'fba费用', '头程运费', '头程税费', '派送运费']
]
...
"""
合并上去的TEMU的订单总金额是str，合并儿子-站点识别码的时候，会自动变成 数值
"""
