...
from config.A0_set_date import RATE_SHIP_FEE, SKU_NW_DISCOUNT
...
# 当仓库属性为空，且跟踪单号有值时，派送费需乘以费率
empty_warehouse_mask = main_file_df['仓库属性'].isna() & main_file_df['跟踪单号'].notna()
main_file_df.loc[empty_warehouse_mask, '派送运费'] = main_file_df.loc[empty_warehouse_mask, '派送运费'] * RATE_SHIP_FEE
