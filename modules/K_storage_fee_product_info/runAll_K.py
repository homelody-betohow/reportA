"""
按顺序执行 K_storage_fee_product_info 目录下的 K1 → K6 全流程脚本。
...
用法：
  ...
  python "modules/K_storage_fee_product_info/runAll_K.py" --stop-after-k5
  
  # 不自动打开文件
  python "modules/K_storage_fee_product_info/runAll_K.py" --open-after-k5=none
"""
