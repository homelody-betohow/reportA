...
CREATE TABLE `sales_order_refund` (
  ...
  `platform_sku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '平台sku（由 sales_order_shipped 按 refund_orig_order_no=order_no 回填）',
