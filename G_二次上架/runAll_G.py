    ...
    for idx, script in enumerate(scripts, start=1):
        ...
        if code == 0:
            ...
            if _is_g2(script):
                ...
                print(f"\n{Color.YELLOW}【如果发现问题】{Color.RESET}")
                print(f"{Color.YELLOW}  - 如果很多「合并-映射账号」为空 → RPA 查询可能遗漏，需重新查询{Color.RESET}")
            ...
            if _is_g3(script):
                ...
                print(f"{Color.YELLOW}  4. 检查「站点」和「儿子-站点识别码」列{Color.RESET}")
                ...
                print(f"    儿子-站点识别码: =VLOOKUP(A列,[手动-二次映射.xlsx]二次上架-LM-BC-自发货!$A:$I,9,FALSE)")
